...
def attack(game_state, move_index):
    ...
    opponent_pokemon = game_state[opponent]['pokemon_team'][opponent_pokemon_index]
...
def bestMove(game_state, top_n=5):
    ...
    for move_index in range(len(moves)):
        ...
        # move is an attack
            ...
            # perform the attack
            attack(game_state_copy, move_index)
